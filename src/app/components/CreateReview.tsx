...
const CreateReview: React.FC<CreateReviewProps> =({ onClose, onReviewSubmit }) => {
  ...
  return (
    <div className="m-auto w-[90%]">
      <h2 className="text-md mb-3 text-center font-medium leading-6">
        Review Location
      </h2>
      ...
      <div>
        ...
        >
          ...
          <div className="mb-4 flex justify-between space-x-2">
            <button
              type="submit"
              className="btn h-[45px] flex-grow rounded-md border-[0.5px] border-primary bg-primary text-white hover:bg-secondary md:h-[50px]"
            >
              SUBMIT
            </button>
            <button
              onClick={onClose}
              type="button"
              className="btn h-[45px] flex-grow rounded-md border-[0.5px] border-primary bg-transparent text-primary hover:border-[1.5px] focus:bg-[#F1F5FF] focus:outline-0 md:h-[50px]"
            >
              CANCEL
            </button>
          </div>
